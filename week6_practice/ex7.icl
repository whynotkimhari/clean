...
triplesum lists = [(x,y,x+y)\\ (x,y) <- lists]
...
tri (l1,l2,l3) = [(x,y,z)\\x<-l1 & y <- l2 & z<-l3]
...
l30 :: [(Int, Int)]
l30 = [(m,dd) \\ m <- [1..12] & d <- [31,28,31,30,31,30,31,31,30,31,30,31], dd <- [1..d]]
