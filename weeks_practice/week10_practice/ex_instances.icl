...
gpaAndFavoriteTeacher uni = {y.studentName \\ y<-uni.students | avg [toReal a\\a<-:y.grades] > 4.0 && y.favoriteTeacher.subject=="Functional"}
...
studentGpa stud = avg [toReal y\\y<-:(stud.grades)]
